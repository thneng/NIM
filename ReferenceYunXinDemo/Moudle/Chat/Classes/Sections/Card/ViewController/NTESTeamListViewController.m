...
#warning 加头像.
    [cell.imageView sd_setImageWithURL:[NSURL URLWithString:team.avatarUrl] placeholderImage:[UIImage imageNamed:@"icon_team_advance_normal"]];
    cell.imageView.layer.cornerRadius = 0.5*40;
